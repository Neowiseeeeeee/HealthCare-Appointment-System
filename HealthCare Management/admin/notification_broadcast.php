                ...
                <div class="col-md-8">
                    <div class="card shadow-sm">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" id="viewHistoryBtn" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#historyModal">
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="historyModalLabel">Notification History</h5>
                        ...
                        setTimeout(function() {
                            ...
                            alertContainer.innerHTML = `
                                <div style="margin-top: 1rem; padding: 0.75rem 1rem; background-color: #d1fae5; color: #047857; border-radius: 0.375rem;">
                                    <i class="fas fa-check-circle"></i> System notification sent successfully to all users.
                                </div>
                            `;
